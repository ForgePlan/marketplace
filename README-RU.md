...
**20 плагинов** | **41 marketplace-aware агентов (91 всего)** | **38+ скиллов** | **9+ баз знаний**
...
| 🧭 [Smith — мастер-оркестратор](docs/SMITH-RU.md) | Карта маршрутизации: 14 контекстов × 29 методологий. Когда и как звать `/smith` — BMAD-мастер, который сам подбирает воркфлоу под задачу |
...
|-----------|-----------|-------|
| **Я хочу мастер-оркестратор** | **fpl-skills + agents-pro** | Начни с `/smith` — маршрутизирует 14 контекстов на 29 методологий |
...
| Routing map (14 контекстов × 29 методологий) | `plugins/fpl-skills/skills/smith/routing-map.md` |
