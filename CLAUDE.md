...
## Plugin versions (catalog v1.126.0)
...
| **slopocop-code** | 1.0.0 (code anti-slop — deterministic 0-100 scanner [JS/TS/Py/Go/Rust, tree-sitter+regex-fallback, per-language idioms] + code-slop skill + /code-audit + /code-deslop + code-slop-cop agent) |
| **dev-toolkit** | 1.6.3 |
