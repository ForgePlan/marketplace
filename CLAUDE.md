...
## Plugin versions (catalog v1.133.0)
...
| **cc-best** | **1.1.1** (commit-trailer example is now a placeholder for the agent's own identity — a hardcoded model name goes stale and gets copied into commits by a model that is not it) |
| **fpl-hsmem** | 2.1.0 |
