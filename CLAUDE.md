...
## Plugin versions (catalog v1.127.0)
...
| **slopocop-code** | 1.1.0 (code anti-slop — deterministic 0-100 scanner [JS/TS/Py/Go/Rust, tree-sitter+regex-fallback, per-language idioms] + code-slop skill + /code-audit + /code-deslop + code-slop-cop agent; v1.1.0 dogfood-fixed 2 scanner false positives — TODO-in-prose + continuation-indent nesting) |
| **dev-toolkit** | 1.6.3 |
