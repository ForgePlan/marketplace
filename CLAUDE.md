...
| **fpl-hsmem** | 2.1.1 |
| **forgeplan-workflow** | **1.16.1** (/forge-cycle наконец двигает фазу артефакта — 300 из 331 активных висели на ранней фазе, потому что её двигали только скиллы починки, marketplace#228. манифест больше не отбраковывается на Claude Code 2.1.257 — убран `components.hooks`, marketplace#242. Sprint Z7: Step 4.5 FPF ADI mandatory for Standard+; Sprint Z6: Step 6.5 BMAD adversarial review mandatory for Standard+) |
