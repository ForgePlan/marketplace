...
|--------|:-------:|---|
| **agents-core** | **1.6.0** (performance-engineer лишён Write/Edit — то же выравнивание B-ревьюера; его собственное описание всегда говорило «передай coder для реализации» — marketplace#236) | RFC-012 — coder GREEN-phase discipline (FR-4) |
