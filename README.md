...
| 🧭 [Smith — master orchestrator](docs/SMITH.md) | Routing map: 14 routing rows × 33 methodologies. When and how to dispatch `/smith` as the BMAD-style master that picks the right workflow for the task |
...
| Routing map (14 routing rows × 33 methodologies) | `plugins/fpl-skills/skills/smith/routing-map.md` |
