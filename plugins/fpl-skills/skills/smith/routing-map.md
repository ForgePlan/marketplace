...
| **discover** | `forgeplan-brownfield-pack` | **B** | 7-phase MCP brownfield discovery; canonical entry for any "legacy" trigger. (Body declares Profile B; it writes findings through `forgeplan_discover_*`, not `forgeplan_new`.) |
