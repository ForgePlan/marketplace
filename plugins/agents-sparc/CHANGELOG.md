...
All notable changes to `agents-sparc` are documented here.
...
had grown into a changelog — for this plugin, 2732 characters of it. The text below is that field,
