...
- `fpl-skills` — это надмножество `dev-toolkit`: те же `/audit` и `/sprint`, 44 скилла всего, плюс `/fpl-init`.
...
- [USAGE-GUIDE-RU.md](USAGE-GUIDE-RU.md) — reference manual для 44 скиллов fpl-skills.
