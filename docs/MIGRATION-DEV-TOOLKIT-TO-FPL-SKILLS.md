...
- `fpl-skills` is a superset of `dev-toolkit` — same `/audit` and `/sprint`, 44 skills in total, plus `/fpl-init`.
...
- [USAGE-GUIDE.md](USAGE-GUIDE.md) — reference manual for fpl-skills' 44 skills.
