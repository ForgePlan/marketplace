...
|---|---|---|
| **fpl-skills** | `plugins/fpl-skills/` | flagship — 44 engineering skills + dev-advisor agent + hooks; hosts **smith** routing brain (`skills/smith/`) |
...
| [`GUIDE-AI-SDLC-PDLC.md`](GUIDE-AI-SDLC-PDLC.md) (+RU) | the umbrella guide — both loops, the 7 CRUD-R-A profiles, the four gate layers, context separation, methodology routing, **and the model-tier ladder** (9 task tiers mapped many-to-one onto model tiers) |
